...
각 룰의 규정 조항 근거(혁신법·시행령 별표 2·사용기준 고시·세법)는 docs/domain-rules.md,
설계 rationale은 docs/DESIGN.md §12 참고. 규정 근거 룰과 내부 운영 룰(80% 경고 등)을
구분해 문서화했다 — 임계값 상수는 규정이 아니라 조정 가능한 운영 파라미터다.
