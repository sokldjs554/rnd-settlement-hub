...
| | |
|---|---|
| ![증빙과 입력값이 전부 일치한 기준선 — 3단 대조와 룰 통과](docs/images/expense-pass.png) | ![금액만 다르게 입력한 건 — R-EVD-002 위반, override 없이 승인 불가](docs/images/expense-fail.png) |
| 증빙·입력값 전부 일치 → 룰 전체 통과 | 금액만 불일치 → R-EVD-002 위반, 승인 차단 권고 |
